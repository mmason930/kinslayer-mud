...
flusspferd::object makeConstants()
{
	...
	o.set_property("PLR_DARKFRIEND", flusspferd::value(PLR_DARKFRIEND));
	o.set_property("PLR_MURDERER", flusspferd::value(PLR_MURDERER));
	o.set_property("PLR_FROZEN", flusspferd::value(PLR_FROZEN));
	o.set_property("PLR_DONTSET", flusspferd::value(PLR_DONTSET));
	o.set_property("PLR_WRITING", flusspferd::value(PLR_WRITING));
	o.set_property("PLR_MAILING", flusspferd::value(PLR_MAILING));
	o.set_property("PLR_CRASH", flusspferd::value(PLR_CRASH));
	o.set_property("PLR_SITEOK", flusspferd::value(PLR_SITEOK));
	o.set_property("PLR_NOSHOUT", flusspferd::value(PLR_NOSHOUT));
	o.set_property("PLR_NOTITLE", flusspferd::value(PLR_NOTITLE));
	o.set_property("PLR_DELETED", flusspferd::value(PLR_DELETED));
	o.set_property("PLR_LOADROOM", flusspferd::value(PLR_LOADROOM));
	o.set_property("PLR_NOWIZLIST", flusspferd::value(PLR_NOWIZLIST));
	o.set_property("PLR_NODELETE", flusspferd::value(PLR_NODELETE));
	o.set_property("PLR_INVSTART", flusspferd::value(PLR_INVSTART));
	o.set_property("PLR_CRYO", flusspferd::value(PLR_CRYO));
	o.set_property("PLR_LOGGER", flusspferd::value(PLR_LOGGER));
	o.set_property("PLR_NOTRACK", flusspferd::value(PLR_NOTRACK));
	o.set_property("PLR_ZONE_BAN", flusspferd::value(PLR_ZONE_BAN));
	o.set_property("PLR_NOIDLE", flusspferd::value(PLR_NOIDLE));
	o.set_property("PLR_NOHOST", flusspferd::value(PLR_NOHOST));
	o.set_property("PLR_NO_WEAVE", flusspferd::value(PLR_NO_WEAVE));
	o.set_property("PLR_NO_TRACE", flusspferd::value(PLR_NO_TRACE));
	o.set_property("PLR_WEAVE_EDITOR", flusspferd::value(PLR_WEAVE_EDITOR));
	o.set_property("PLR_STAT_EDITOR", flusspferd::value(PLR_STAT_EDITOR));
	o.set_property("PLR_CHARGE_EDITOR", flusspferd::value(PLR_CHARGE_EDITOR));
	o.set_property("PLR_NOGLOBAL", flusspferd::value(PLR_NOGLOBAL));
	o.set_property("PLR_GLOBAL_SCRIPTS", flusspferd::value(PLR_GLOBAL_SCRIPTS));

	o.set_property("PRF_BRIEF", flusspferd::value(PRF_BRIEF));
	o.set_property("PRF_COMPACT", flusspferd::value(PRF_COMPACT));
	o.set_property("PRF_SOURCE", flusspferd::value(PRF_SOURCE));
	o.set_property("PRF_NOTELL", flusspferd::value(PRF_NOTELL));
	o.set_property("PRF_DISPHP", flusspferd::value(PRF_DISPHP));
	o.set_property("PRF_DISPMANA", flusspferd::value(PRF_DISPMANA));
	o.set_property("PRF_DISPMOVE", flusspferd::value(PRF_DISPMOVE));
	o.set_property("PRF_AUTOEXIT", flusspferd::value(PRF_AUTOEXIT));
	o.set_property("PRF_NOHASSLE", flusspferd::value(PRF_NOHASSLE));
	o.set_property("PRF_NOREPEAT", flusspferd::value(PRF_NOREPEAT));
	o.set_property("PRF_HOLYLIGHT", flusspferd::value(PRF_HOLYLIGHT));
	o.set_property("PRF_COLOR_1", flusspferd::value(PRF_COLOR_1));
	o.set_property("PRF_COLOR_2", flusspferd::value(PRF_COLOR_2));
	o.set_property("PRF_NOWIZ", flusspferd::value(PRF_NOWIZ));
	o.set_property("PRF_LOG1", flusspferd::value(PRF_LOG1));
	o.set_property("PRF_LOG2", flusspferd::value(PRF_LOG2));
	o.set_property("PRF_NOSPEAKS", flusspferd::value(PRF_NOSPEAKS));
	o.set_property("PRF_ROOMFLAGS", flusspferd::value(PRF_ROOMFLAGS));
	o.set_property("PRF_STATTED", flusspferd::value(PRF_STATTED));
	o.set_property("PRF_INCOG", flusspferd::value(PRF_INCOG));
	o.set_property("PRF_TELL_MUTE", flusspferd::value(PRF_TELL_MUTE));
	o.set_property("PRF_SAY_MUTE", flusspferd::value(PRF_SAY_MUTE));
	o.set_property("PRF_NONARR", flusspferd::value(PRF_NONARR));
	o.set_property("PRF_NOCHAT", flusspferd::value(PRF_NOCHAT));
	o.set_property("PRF_NOYELL", flusspferd::value(PRF_NOYELL));
	o.set_property("PRF_NOSHOUT", flusspferd::value(PRF_NOSHOUT));
	o.set_property("PRF_BUILDWALK", flusspferd::value(PRF_BUILDWALK));
	o.set_property("PRF_SPAM", flusspferd::value(PRF_SPAM));
	o.set_property("PRF_GCOMM_1", flusspferd::value(PRF_GCOMM_1));
	o.set_property("PRF_GCOMM_2", flusspferd::value(PRF_GCOMM_2));
	o.set_property("PRF_AUTOSCAN", flusspferd::value(PRF_AUTOSCAN));
	o.set_property("PRF_NOGLOBAL", flusspferd::value(PRF_NOGLOBAL));
