...
const int ROOM_INACCESSIBLE	= 3;	// Inaccessible to players - block gating, fading, etc
...
const int PRF_UNUSED1 = 9;   // NOT USED
const int PRF_UNUSED2 = 10;  // NOT USED
...
const int PRF_UNUSED3 = 19;  // NOT USED
const int PRF_UNUSED4 = 20;  // NOT USED
const int PRF_ROOMFLAGS = 21;// Can see room flags ROOM_x
const int PRF_UNUSED5 = 22;  // NOT USED
const int PRF_STATTED = 23;  // Char has been statted
const int PRF_UNUSED6 = 24;  // NOT USED
...
const int PRF_UNUSED7 = 34;  // NOT USED
...
const int ITEM_CHEST = 7; // Item is a chest, and items inside of it save over reboots
