...
In the KinslayerMUD world there are different types of character options known as "classes". These classes differ depending on which race is chosen. There are two races available: human and trolloc.<br/>
