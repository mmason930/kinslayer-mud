...
${CXX:-g++} -std=c++23 -O1 -g -fsanitize=address,undefined -fno-omit-frame-pointer \
    ...
    src/ku/kuListener.cpp src/gateway/GatewayDescriptor.cpp \
    src/jsoncpp/json_reader.cpp src/jsoncpp/json_value.cpp src/jsoncpp/json_writer.cpp \
    -Wl,--gc-sections -lcrypto -o "$test_dir/gateway-network"
