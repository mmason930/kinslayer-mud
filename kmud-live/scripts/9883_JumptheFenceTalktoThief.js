...
if ( actor.quest(qName) == 1 && !actor.questTaskProgress(qName)[2].comp ) {
	_block;
	waitpulse 10;
	...
	waitpulse 10;
	actor.addQuestItem("a delicate ceremonial dagger",1,qName);
	actor.addQuestItem("a small clay sculpture",1,qName);
	actor.addQuestItem("a bolt of golden silk",1,qName);
	waitpulse 15;
