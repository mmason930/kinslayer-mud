...
{
	var novice = getSval(self,22815,"novice");
var targetRoom = getRoom(10575);
        ...
        novice.comm("look");
	wait 10;
		var args = getArgList(args.toLowerCase());
		if (phraseMatch(args, "I wish to accompany you Sheriam\\.?$")) {
                actor.send("You step through the portal.");
                act("$n steps into the portal.",false,actor,null,null,constants.TO_ROOM);
                actor.moveToRoom(10575);
        ...
        wait 4;
        self.say("This is your last chance, " + novice.name + ". Refuse now, and it counts only as the first. You may still try twice more. If you accept now, there is no turning back. It is no shame to refuse. I could not do it, my first time. If you accept, hand over your belongings.");
