...
HelpManager.prototype.getWorldMap = function(actor, bool)
{
	...
	var leg1          = [1,12,"Typ","   ",-1,bld];
	var leg2          = [2,12,"e M","   ",-1,bld];
	var leg3          = [3,12,"AP ","   ",-1,bld];
	var leg4          = [4,12,"LEG","   ",-1,bld];
	var leg5          = [5,12,"END","   ",-1,bld];
	var leg6          = [6,12," to","   ",-1,bld];
	var leg7          = [7,12," to","   ",-1,bld];
	var leg8          = [8,12,"ggl","   ",-1,bld];
	var leg9          = [9,12,"e l","   ",-1,bld];
	var leg10         = [10,12,"ege","   ",-1,bld];
	var leg11         = [11,12,"nd ","   ",-1,bld];
