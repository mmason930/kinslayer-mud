var script20704 = function(self, actor, here, args, extra) {
	//getCharCols(actor);
	wait 1;
	if (self.race == actor.race)
	{
	self.say("I'll buy any ore, coal, or diamonds from you! Just hand them over.");
	}
	else
	{
	...
	var list = self.getPval("orelist").split("~");
	...
	{
	var money = getObjProto(parseInt(list[i-1])).cost*11;
