...
const int PRF_QUEST = 9; // On quest
...
const int PRF_SPARETWO = 19; // Can't hear gossip channel
const int PRF_SPARETHREE = 20; // Can't hear grats channel
...
const int PRF_UNUSED1 = 24; // Currently unused
...
const int PRF_ALERT = 34; //Player receives alert messages.
...
const int ITEM_CHAIN = 5; // Item hits anyone fighting you
