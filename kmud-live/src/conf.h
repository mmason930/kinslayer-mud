/*
 * conf.h.unix_or_windows, this should work for both Windows and Linux compilers
 */
...
#else	//End of Windows Configuration, now we assume we're using Linux
...
#endif	//End of Linux Configuration
