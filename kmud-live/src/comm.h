...
#define LAG_MONITOR_INVISIBLE_PING			 "INVISIBLE_PING"
#define LAG_MONITOR_ARCHIVE_FORUM_USERS		 "LAG_MONITOR_ARCHIVE_FORUM_USERS"
#define LAG_MONITOR_WEBSOCKET_COMMANDS		 "WEBSOCKET_COMMANDS"
#define LAG_MONITOR_PLAYER_PORTAL_SERVER	 "PLAYER_PORTAL_SERVER"
