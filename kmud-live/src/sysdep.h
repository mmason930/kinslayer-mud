...
#ifndef CIRCLE_SYSDEP_H
#define CIRCLE_SYSDEP_H
...
//Memory leak detection for Microsoft Visual Studio... Override the stdlib new/delete keywords
#ifdef WIN32
#define _CRTDBG_MAP_ALLOC
#include <crtdbg.h>

#if (defined _DEBUG && defined _MEM_LEAKS)
...
//Mute the annoying VS .NET deprecation errors.
#if defined(WIN32)
...
#elif defined(CIRCLE_MACINTOSH)	/* Mastd::cintosh definitions. */
