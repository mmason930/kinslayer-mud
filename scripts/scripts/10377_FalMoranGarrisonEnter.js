var script10377 = function(self, actor, here, args, extra) {
	...
	if(actor.affectedBy(constants.AFF_NOQUIT)) {
	        ...
	        here.echoaround( actor, actor.name + " opens a door to the north." );
	        actor.send( "You open a door to the north." );
	        waitpulse 5;
	        actor.send("You enter the garrison.");
	        actor.moveToRoom(getRoom(10378));
	        actor.comm("look");
	        here.echo( actor.name + " leaves north." );
	        waitpulse 5;
