var script13516 = function(self, actor, here, args, extra) {
	...
	if( dir == constants.WEST || dir == constants.EAST ) {
	        ...
	        here.echoaround(actor, capFirstLetter(actor.name) + " jumps from " + actor.hisHer() + " boat and tries to climb up the bridge!");
	        actor.startTimer(3)
	        ...
	        {//25% chance of slipping back in
	            if( random(1,100) <= 25 ) {
	                    //Fail.
	                        ...
	                        here.echoaround(actor, capFirstLetter(actor.name) + " looses" + actor.hisHer() + " footing and falls back down into the boat.");
	                    ...
	                    //Success.
	                        ...
	                        actor.comm("look");
	                        actor.room.echoaround(actor, capFirstLetter(actor.name) + " climbs up and out of " + actor.hisHer() + "boat.");
	                }
	        }
	}
}
